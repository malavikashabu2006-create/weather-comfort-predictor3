...
# Since your model was trained on a scaled target variable in Colab, it outputs a Z-score 
# (e.g., 1.70 means 1.70 standard deviations above the mean). We unscale it back to the 0-10 range!
